...
export default function AppContainer({ children, darkMode }: Readonly<AppContainerProps>) {
  return (
    <main
      className={`${darkMode ? 'dark' : ''} dark:bg-quartz-100 bg-noise-light dark:bg-noise-dark flex min-h-screen items-center justify-center overflow-hidden bg-slate-100 bg-repeat transition-colors duration-300`}
    >
